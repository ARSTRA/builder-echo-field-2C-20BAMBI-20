...
export default function NotificationsPage() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message:
        "Your ride with John Smith is confirmed. Driver will arrive in 3 minutes.",
    ...
    },
    {
      ...
      message:
        "John Smith has arrived at your pickup location. Vehicle: Honda Civic (ABC-1234)",
    ...
    },
    {
      ...
      message:
        "Limited time offer! Use code SAVE50 for 50% off your next 3 rides.",
    ...
    },
    {
      ...
      message:
        "Payment of $24.50 for trip TR001234 has been processed successfully.",
    ...
    },
    {
      ...
      message:
        "New features and improvements are available. Update now for the best experience.",
      timestamp: "1 day ago",
      read: false,
      priority: "medium",
      icon: Smartphone,
    ...
    },
    {
      ...
      message:
        "Your emergency contact has been notified that you've reached your destination safely.",
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case "system":
        return "bg-taxi-purple/10 text-taxi-purple";
      case "safety":
        return "bg-success/10 text-success";
      default:
      ...
      <div className="px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-start space-x-3">
                      <div
                        className={`w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center ${notification.color}`}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          <h3
                            className={`font-semibold ${!notification.read ? "text-taxi-dark" : "text-taxi-gray"}`}
                          >
                            {notification.title}
                          </h3>
                          <div className="flex items-center space-x-2">
                        ...
                        <p
                          className={`text-sm ${!notification.read ? "text-taxi-gray" : "text-taxi-gray/70"} mb-2`}
                        >
          ...
          <TabsContent value="booking" className="space-y-4">
            {getNotificationsByType("booking")
              .concat(getNotificationsByType("driver"))
              .map((notification) => {
                const Icon = notification.icon;
                return (
                    ...
                    {[
                      {
                        ...
                        desc: "Ride confirmations, driver updates",
                      },
                      {
                        key: "driverMessages",
                        label: "Driver Messages",
                        desc: "Messages from your driver",
                      },
                      {
                        key: "promotions",
                      ...
                      },
                      {
                        key: "safetyAlerts",
                        label: "Safety Alerts",
                        desc: "Emergency and safety notifications",
                      },
                    ].map((setting) => (
                      <div
                        key={setting.key}
        ...
        {/* Empty State */}
        {getNotificationsByType(activeTab).length === 0 &&
          activeTab !== "settings" && (
