...
export default function DriverDashboard() {
  ...
  const handleToggleOnline = () => {
    ...
    toast.success(`You are now ${!isOnline ? 'online' : 'offline'}`, {
      description: !isOnline ? "You'll start receiving ride requests" : "You won't receive new ride requests"
    });
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-right">
                ...
                <div className="text-lg font-bold text-green-600">${driverEarnings.today.toFixed(2)}</div>
              </div>
                ...
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center justify-between">
                    <div className="flex items-center">
                      <Activity className={`w-5 h-5 mr-2 ${isOnline ? 'text-green-500' : 'text-gray-400'}`} />
                      Driver Status
                    </div>
                  ...
                  {isOnline ? (
                    <div className="space-y-4">
                      <div className="text-center p-6 bg-green-50 rounded-lg">
                        ...
                        <h3 className="text-lg font-semibold text-green-800 mb-2">Searching for Rides</h3>
                        <p className="text-sm text-green-600">You're online and ready to accept ride requests</p>
                      </div>
                      
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div>
                          <div className="text-2xl font-bold text-gray-900">{rideRequests.length}</div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-yellow-600">{driverProfile.rating}</p>
                      </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Downtown to Airport • 2:30 PM</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Completed 10 rides today</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">From Sarah Wilson</p>
                      </div>
                    </div>
              ...
              <CardContent>
                {rideRequests.length > 0 ? (
                      ...
                      <div key={request.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow bg-white">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h3 className="font-semibold">{request.passengerName}</h3>
                              <div className="flex items-center space-x-1">
                                <Star className="w-3 h-3 text-yellow-400 fill-current" />
                                <span className="text-sm text-gray-600">{request.rating}</span>
                                <span className="text-sm text-gray-400">• {request.time}</span>
                              </div>
                            </div>
                          </div>
                          <div className="text-right">
                  ...
                  <div className="text-center p-8">
                    ...
                    <h3 className="text-lg font-semibold text-gray-600 mb-2">No Ride Requests</h3>
            ...
            {currentRide ? (
                ...
                <Card className="shadow-xl">
                  ...
                  <CardContent className="p-0">
                    <div 
                      ...
                      style={{
                        backgroundImage: "url('https://images.unsplash.com/photo-1569336415962-a4bd9f69cd83?w=800&h=400&fit=crop&crop=center')"
                      }}
                    >
                  ...
                  <Card className="shadow-lg">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <h3 className="font-semibold">{currentRide.passengerName}</h3>
                            <div className="flex items-center space-x-1">
                              <Star className="w-3 h-3 text-yellow-400 fill-current" />
                          ...
                          <div className="text-right">
                            <div className="text-lg font-bold text-green-600">${currentRide.estimatedFare}</div>
                            <div className="text-sm text-gray-500">{currentRide.distance}</div>
                          </div>
                        </div>
                  ...
                  <Card className="shadow-lg">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button 
                          variant="outline"
                          onClick={() => toast.info("Traffic conditions updated")}
                        >
                        ...
                        <Button 
                          variant="outline"
                          onClick={() => toast.info("Emergency services notified")}
                        >
              ...
              <Card className="shadow-lg">
                <CardContent className="text-center p-12">
                  ...
                  <p className="text-gray-500">Accept a ride request to start navigation</p>
                </CardContent>
              </Card>
            )}
          </TabsContent>
          ...
          <TabsContent value="earnings" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-green-600 mb-2">${driverEarnings.today.toFixed(2)}</div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-600 mb-2">${driverEarnings.week.toFixed(2)}</div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-purple-600 mb-2">${driverEarnings.month.toFixed(2)}</div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-orange-600 mb-2">${driverEarnings.total.toFixed(2)}</div>
                ...
                <div className="space-y-4">
                  {incomeData.dailyEarnings.map((day, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="w-20 text-right font-semibold text-green-600">${day.amount.toFixed(2)}</div>
                    </div>
                  ))}
                </div>
              </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                      ...
                      <span className="font-semibold text-purple-600">+${incomeData.bonuses.daily.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                      <span className="text-sm">Weekly Target</span>
                      <span className="font-semibold text-blue-600">+${incomeData.bonuses.weekly.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                      <span className="text-sm">Referral Bonus</span>
                      <span className="font-semibold text-green-600">+${incomeData.bonuses.referral.toFixed(2)}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                      ...
                      <span className="font-semibold text-red-600">-${incomeData.expenses.fuel.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                      <span className="text-sm">Maintenance</span>
                      <span className="font-semibold text-orange-600">-${incomeData.expenses.maintenance.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                      <span className="text-sm">Insurance</span>
                      <span className="font-semibold text-yellow-600">-${incomeData.expenses.insurance.toFixed(2)}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="text-center">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-semibold">{driverProfile.firstName} {driverProfile.lastName}</h3>
                    <div className="flex items-center justify-center space-x-2">
                      <Star className="w-4 h-4 text-yellow-400 fill-current" />
                      <span className="font-medium">{driverProfile.rating}</span>
                      <span className="text-gray-500">• {driverProfile.totalRides} rides</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDriverProfile(prev => ({ ...prev, firstName: e.target.value }))}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDriverProfile(prev => ({ ...prev, lastName: e.target.value }))}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, email: e.target.value }))}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, address: e.target.value }))}
                    />
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, vehicleMake: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, vehicleModel: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, vehicleYear: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, vehicleColor: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, licensePlate: e.target.value }))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setDriverProfile(prev => ({ ...prev, licenseNumber: e.target.value }))}
                    />
                  </div>
                </div>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-medium text-blue-800 mb-2">Upload New Document</h4>
                  <div className="flex items-center space-x-3">
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="medical-cert">Medical Certificate</SelectItem>
                        <SelectItem value="tax-clearance">Tax Clearance</SelectItem>
                      </SelectContent>
                    </Select>
                    <Button onClick={() => toast.success("Document upload initiated")}>
                      <Upload className="w-4 h-4 mr-2" />
                      Upload Document
                    </Button>
                  </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start space-x-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                            ...
                            notification.type === 'bonus' ? 'bg-green-100' : 'bg-yellow-100'
                          }`}>
                            {notification.type === 'ride' && <Car className="w-4 h-4 text-blue-600" />}
                            {notification.type === 'bonus' && <Gift className="w-4 h-4 text-green-600" />}
                            {notification.type === 'document' && <FileText className="w-4 h-4 text-yellow-600" />}
                          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Expiration and renewal reminders</p>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="space-y-2">
                          <Label htmlFor="maxDistance">Maximum pickup distance</Label>
                          <Select>
                            <SelectTrigger>
                      ...
                      <div className="p-3 border rounded-lg bg-gradient-to-r from-purple-50 to-pink-50">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">20% off at partner stations</p>
                          </div>
                      ...
                      <div className="p-3 border rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">$50 service credit</p>
                          </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-green-50 rounded-lg">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-green-700">Earn for each new driver referral</p>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="weeklyReport">Weekly earnings report</Label>
                      <p className="text-sm text-gray-500">Automatically sent every Monday</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="monthlyStatement">Monthly statement</Label>
                      <p className="text-sm text-gray-500">Tax-ready earnings summary</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Special offers and opportunities</p>
                    </div>
