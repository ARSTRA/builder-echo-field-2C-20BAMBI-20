...
export default function EarningsPage() {
  ...
  const expenses = [
    { category: "Fuel", amount: 120.5, percentage: 50 },
    { category: "Vehicle Maintenance", amount: 65.3, percentage: 27 },
    { category: "Insurance", amount: 35.0, percentage: 15 },
    { category: "Tolls & Parking", amount: 20.0, percentage: 8 },
  ];

  const getCurrentPeriodData = () => {
    return (
      earningsPeriods.find((p) =>
        p.period.toLowerCase().includes(selectedPeriod),
      ) || earningsPeriods[1]
    );
  };
          ...
          <CardContent className="p-6">
            <div className="text-center mb-4">
              ...
              <p className="text-taxi-gray">
                Total Earnings - {currentData.period}
              </p>
            </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">
                      ${earningsBreakdown.baseFares}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-taxi-gray">
                      Surge Pricing
                    </span>
                    <span className="font-medium text-warning">
                      ${earningsBreakdown.surgePricing}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-taxi-gray">Tips</span>
                    <span className="font-medium text-success">
                      ${earningsBreakdown.tips}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
            ...
            <Card className="mobile-card">
              ...
              <CardContent className="pt-0 space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ${(currentData.total * 0.4).toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2 mb-3 text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-taxi-gray truncate">
                        {trip.from}
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
              ...
              <CardContent className="pt-0 space-y-6">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-medium">
                      ${weeklyGoals.earnings.current}/$
                      {weeklyGoals.earnings.target}
                    </span>
                  </div>
                  <Progress
                    value={weeklyGoals.earnings.percentage}
                    className="h-3"
                  />
                  <p className="text-xs text-taxi-gray mt-1">
                    {weeklyGoals.earnings.percentage.toFixed(1)}% complete
                  </p>
                </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-medium">
                      {weeklyGoals.trips.current}/{weeklyGoals.trips.target}
                    </span>
                  </div>
                  <Progress
                    value={weeklyGoals.trips.percentage}
                    className="h-3"
                  />
                  <p className="text-xs text-taxi-gray mt-1">
                    {weeklyGoals.trips.percentage.toFixed(1)}% complete
                  </p>
                </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-medium">
                      {weeklyGoals.rating.current}/{weeklyGoals.rating.target}
                    </span>
                  </div>
                  <Progress
                    value={weeklyGoals.rating.percentage}
                    className="h-3"
                  />
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-medium">
                      {weeklyGoals.hours.current}h/{weeklyGoals.hours.target}h
                    </span>
                  </div>
                  <Progress
                    value={weeklyGoals.hours.percentage}
                    className="h-3"
                  />
                  <p className="text-xs text-taxi-gray mt-1">
                    {weeklyGoals.hours.percentage.toFixed(1)}% complete
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-0 space-y-3">
                <div className="p-3 bg-warning/10 rounded-lg border border-warning/20">
                  ...
                  <p className="text-sm text-taxi-gray">
                    Complete 5 trips during 7-9 AM or 5-7 PM
                  </p>
                  <div className="mt-2">
                    <Progress value={60} className="h-2" />
                    <p className="text-xs text-taxi-gray mt-1">
                      3 of 5 trips completed
                    </p>
                  </div>
                </div>
                ...
                <div className="p-3 bg-accent/10 rounded-lg border border-accent/20">
                  ...
                  <p className="text-sm text-taxi-gray">
                    Complete 20 trips this weekend
                  </p>
                  <div className="mt-2">
                    <Progress value={35} className="h-2" />
                    <p className="text-xs text-taxi-gray mt-1">
                      7 of 20 trips completed
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="mobile-card">
              ...
              <CardContent className="pt-0 space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-taxi-dark">
                      Track Fuel Costs
                    </h4>
                    <p className="text-sm text-taxi-gray">
